package com.testshop.webapp.UnitTest;
...
import com.testshop.webapp.repository.UtentiRepository;
...
public class UtentiControllerTest
{
    ...
    {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/utenti/cerca/userid/Enrico")
                        .accept(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$.userId").value("Enrico"))
        ...
        assertThat(passwordEncoder.matches("123_Stella",
                utentiRepository.findByUserId("Enrico").getPassword()))
                .isEqualTo(true);
    }
    ...
    public void testGetAllUser() throws Exception
    {
        mockMvc.perform(MockMvcRequestBuilders.get("/api/utenti/cerca/tutti")
                ...
                .andExpect(jsonPath("$[0].userId").value("Enrico"))
    ...
    {
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/utenti/elimina/Enrico")
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value("200 OK"))
                .andExpect(jsonPath("$.message").value("Eliminazione Utente Enrico Eseguita Con Successo"))
                .andDo(print());
    }
